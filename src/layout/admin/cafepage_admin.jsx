        ...
        {cafes.map((cafe, index) => (
          ...
          >
            ...
            <div className="relative group">
              ...
              />
              <Link to="/cafeadmin" className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center text-white text-lg font-medium">
                ดูเพิ่มเติม
              </Link>
            </div>
